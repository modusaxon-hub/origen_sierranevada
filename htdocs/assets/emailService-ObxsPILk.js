import{s}from"./index-CrxIS3Uf.js";const i="https://origen2025.share.zrok.io",d=`${i}/logo-origen-sierra-nevada.svg`,m={sendWelcomeEmail:async(r,a)=>{try{const{data:o,error:e}=await s.functions.invoke("send-email",{body:{to:r,subject:"🌿 Tu Ritual comienza aquí: Bienvenido a Origen Sierra Nevada",html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                            ...
                            <div class="container">
                                ...
                                <div class="content">
                                    ...
                                    <div style="margin-top: 40px;">
                                        <a href="${i}" class="btn">Explorar el Origen</a>
                                    </div>
                                </div>
                                <div class="footer">
                    ...
                    `}});if(e)throw e;return{success:!0,data:o}}catch(o){return console.error("Error in sendWelcomeEmail:",o),{success:!1,error:o}}},sendApprovalEmail:async(r,a)=>{try{const{data:o,error:e}=await s.functions.invoke("send-email",{body:{to:r,subject:"✨ Acceso Concedido: Bienvenido al Círculo de Origen",html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                            ...
                            <div class="container">
                                ...
                                <div class="content">
                                    ...
                                    <div style="margin: 40px 0;">
                                        <a href="${i}/#/login" class="btn">Iniciar el Ritual de Compra</a>
                                    </div>
                    ...
                    `}});if(e)throw e;return{success:!0,data:o}}catch(o){return console.error("Error in sendApprovalEmail:",o),{success:!1,error:o}}},sendOrderNotification:async(r,a)=>{try{const{data:o,error:e}=await s.functions.invoke("send-email",{body:{to:r,subject:`🔔 Origen Alert: ${a.type||"Nueva Actividad"}`,html:`
                        <div style="font-family: sans-serif; color: #ffffff; background: #050806; padding: 40px; border-radius: 20px; border: 1px solid #C5A065;">
                            ...
                            <div style="margin-top: 32px; text-align: center;">
                                <a href="${i}/#/admin" style="background: #C5A065; color: #000; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 12px; text-transform: uppercase;">Abrir Panel de Control</a>
                            </div>
                        </div>
                    `}});if(e)throw e;return{success:!0,data:o}}catch(o){return console.error("Error in sendOrderNotification:",o),{success:!1,error:o}}},sendCustomerOrderEmail:async(r,a,o)=>{try{const{data:e,error:n}=await s.functions.invoke("send-email",{body:{to:r,subject:`☕ Tu Ritual está en camino - Pedido #${o.orderId.slice(0,8)}`,html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                        ...
                        <body>
                            <div class="container">
                                <div class="content">
                                    ...
                                    <a href="${i}/#/account" style="display: inline-block; background: #C5A065; color: #000; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: bold; margin-top: 24px; font-size: 12px; text-transform: uppercase;">Rastrear mi pedido</a>
                                </div>
                                <div class="footer">ORIGEN SIERRA NEVADA SM • SANTA MARTA, COLOMBIA</div>
                            </div>
                        </body>
                        </html>
                    `}});return{success:!n,data:e}}catch(e){return{success:!1,error:e}}},sendNewsletterWelcome:async r=>{try{const{data:a,error:o}=await s.functions.invoke("send-email",{body:{to:r,subject:"🌿 Bienvenido al Ritual de Origen Sierra Nevada",html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                        ...
                        <body>
                            <div class="container">
                                <div style="padding: 40px 0;">
                                    <img src="${d}" width="100" alt="Origen Logo">
                                </div>
                                <div class="content">
                                    ...
                                    <a href="${i}/#/subscription" class="btn">Explorar Suscripciones</a>
                                </div>
                                <div class="footer">
                    ...
                    `}});return{success:!o,data:a}}catch(a){return console.error("Error sending newsletter email:",a),{success:!1,error:a}}},sendStatusUpdateEmail:async(r,a,o,e,n)=>{const t={pending_payment:{label:"Esperando Pago",emoji:"⏳",color:"#FF7043"},pending:{label:"Por Confirmar",emoji:"🧐",color:"#FFB74D"},paid:{label:"Pago Confirmado",emoji:"✅",color:"#66BB6A"},processing:{label:"Preparando tu Café",emoji:"☕",color:"#C5A065"},shipped:{label:"Pedido Enviado",emoji:"🚚",color:"#42A5F5"},delivered:{label:"Entregado",emoji:"🏠",color:"#AB47BC"},cancelled:{label:"Pedido Cancelado",emoji:"❌",color:"#EF5350"}}[e]||{label:e,emoji:"🔔",color:"#C5A065"};try{const{data:l,error:p}=await s.functions.invoke("send-email",{body:{to:r,subject:`${t.emoji} Actualización: Pedido #${o.slice(0,8)} - ${t.label}`,html:`
                        <div style="background-color: #050806; padding: 40px; font-family: sans-serif; color: white; text-align: center; border: 1px solid #C5A065; border-radius: 20px;">
                            ...
                            <h2 style="color: #C5A065;">Hola ${a},</h2>
                            <p style="color: rgba(255,255,255,0.7);">Tu pedido tiene una nueva actualización en su ritual de entrega:</p>
                            
                            <div style="background: rgba(255,255,255,0.05); padding: 30px; border-radius: 16px; margin: 30px 0; border: 1px solid ${t.color}44;">
                                <span style="font-size: 40px; display: block; margin-bottom: 10px;">${t.emoji}</span>
                                <span style="font-size: 10px; text-transform: uppercase; letter-spacing: 0.2em; color: ${t.color}; font-weight: bold;">Nuevo Estado</span>
                                <h1 style="color: ${t.color}; margin-top: 10px; font-size: 24px;">${t.label}</h1>
                            </div>
                            ...
                            ${e==="shipped"&&n?`
                                <div style="background: rgba(66, 165, 245, 0.1); border: 1px dashed #42A5F5; border-radius: 12px; padding: 20px; text-align: left; margin-bottom: 30px;">
                                    ...
                                    <p style="color: white; font-size: 14px; margin-bottom: 15px;">${n.note||"Tu pedido ya está en manos de la transportadora."}</p>
                                    ${n.receiptUrl?`
                                        <div style="text-align: center;">
                                            ...
                                            <img src="${n.receiptUrl}" style="max-width: 100%; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);">
                                        </div>
                                    `:""}
                                </div>
                            `:""}
                            ...
                            <div style="margin-top: 40px;">
                                <a href="${i}/#/track/${o}" style="background: #C5A065; color: black; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 11px; text-transform: uppercase; letter-spacing: 1px;">Ver Detalles del Pedido</a>
                            </div>
                    ...
                    `}});return{success:!p,data:l}}catch(l){return{success:!1,error:l}}}};export{m as emailService};
