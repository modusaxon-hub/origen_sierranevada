import{s as n}from"./index-X1tO6GpK.js";const p={whatsapp:{number:"+573107405154",baseUrl:"https://wa.me"},email:{support:"origensierranevadasm@gmail.com",admin:"origensierranevadasm@gmail.com",comercial:"origensierranevadasm@gmail.com"}},c=e=>{const a=`${p.whatsapp.baseUrl}/${p.whatsapp.number}`;if(!e)return a;const o=encodeURIComponent(e);return`${a}?text=${o}`},g=(e,a)=>{const o={order:a?`Hola, quiero confirmar mi pedido #${a.slice(0,8).toUpperCase()} enviando comprobante de pago.`:"Hola, quiero confirmar mi pedido enviando comprobante de pago.",support:"Hola, necesito ayuda con mi cuenta de Origen Sierra Nevada.",info:"Hola, quiero conocer más sobre los productos de Origen Sierra Nevada."};return o[e]||o.info},h=(e,a)=>{const o=g(e,a);return c(o)},b=e=>{const a=e.orderId.slice(0,8).toUpperCase(),o=e.items.map(t=>`• ${t.quantity}x ${t.name} — $${t.unitPrice.toLocaleString("es-CO")} = $${t.subtotal.toLocaleString("es-CO")}`).join(`
`);return["*COMPROBANTE DE PAGO — ORIGEN SIERRA NEVADA*",`Pedido: #${a}`,"","*PRODUCTOS:*",o,"",`Subtotal: $${e.subtotal.toLocaleString("es-CO")}`,e.discount>0?`Descuento: -$${e.discount.toLocaleString("es-CO")}`:null,`Envío: ${e.shipping===0?"GRATIS":"$"+e.shipping.toLocaleString("es-CO")}`,`*TOTAL: $${e.total.toLocaleString("es-CO")} COP*`,"","*ENVÍO A:*",`${e.customerName}`,`${e.address}, ${e.city}, ${e.department}`,`Tel: ${e.customerPhone}`,e.proofUrl?`
Comprobante: ${e.proofUrl}`:`
Adjunto comprobante en esta conversación.`].filter(Boolean).join(`
`)},y=e=>c(b(e)),s=typeof window<"u"?window.location.origin:"https://origensierranevada.co",d="https://oawhbhoywqfgnqgdyyer.supabase.co/storage/v1/object/public/brand/logo-origen-sierra-nevada.svg",x={sendWelcomeEmail:async(e,a)=>{try{const{data:o,error:t}=await n.functions.invoke("send-email",{body:{to:e,subject:"🌿 Tu Experiencia comienza aquí: Bienvenido a Origen Sierra Nevada",html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                            ...
                            <div class="container">
                                <div class="hero">
                                    ...
                                    <div style="position: absolute; bottom: 40px; width: 100%; text-align: center;">
                                        <img src="${d}" class="logo" alt="Logo">
                                    </div>
                                </div>
                                <div class="content">
                                    <h1>Un viaje sagrado ha comenzado...</h1>
                                    <p>Hola, <strong>${a}</strong>. <br><br> Es un honor recibir tu solicitud para formar parte de nuestra comunidad. En Origen Sierra Nevada, no solo vendemos café; cultivamos una conexión mística entre la montaña y tu espíritu.</p>
                                    ...
                                    <div style="margin-top: 40px;">
                                        <a href="${s}" class="btn">Explorar el Origen</a>
                                    </div>
                                </div>
                                <div class="footer">
                    ...
                    `}});if(t)throw t;return{success:!0,data:o}}catch(o){return console.error("Error in sendWelcomeEmail:",o),{success:!1,error:o}}},sendApprovalEmail:async(e,a)=>{try{const{data:o,error:t}=await n.functions.invoke("send-email",{body:{to:e,subject:"✨ Acceso Concedido: Bienvenido al Círculo de Origen",html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                        ...
                        <body>
                            <div class="container">
                                ...
                                <div class="content">
                                    ...
                                    <p>Hola, <strong>${a}</strong>. <br><br> La montaña ha hablado. Tu alma ha sido bienvenida al círculo interno de Origen Sierra Nevada.</p>
                                    ...
                                    <div style="margin: 40px 0;">
                                        <a href="${s}/#/login" class="btn">Iniciar la Experiencia de Compra</a>
                                    </div>
                                    ...
                                    <div style="margin: 40px 0; text-align: center; border-top: 1px solid rgba(200, 170, 110, 0.2); padding-top: 24px;">
                                        ...
                                        <a href="https://wa.me/${p.whatsapp.number.replace("+","")}?text=${encodeURIComponent(g("support"))}"
                    ...
                    `}});if(t)throw t;return{success:!0,data:o}}catch(o){return console.error("Error in sendApprovalEmail:",o),{success:!1,error:o}}},sendOrderNotification:async(e,a)=>{try{const{data:o,error:t}=await n.functions.invoke("send-email",{body:{to:e,subject:`🔔 Origen Alert: ${a.type||"Nueva Actividad"}`,html:`
                        <div style="font-family: sans-serif; color: #ffffff; background: #050806; padding: 40px; border-radius: 20px; border: 1px solid #C8AA6E;">
                            ...
                            <div style="background: rgba(255,255,255,0.05); padding: 24px; border-radius: 12px; border: 1px solid rgba(200, 170, 110, 0.2);">
                                <pre style="margin: 0; color: #FBF5B7; font-size: 14px;">${JSON.stringify(a,null,2)}</pre>
                            </div>
                            <div style="margin-top: 32px; text-align: center;">
                                <a href="${s}/#/admin" style="background: #C8AA6E; color: #000; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 12px; text-transform: uppercase;">Abrir Panel de Control</a>
                            </div>
                        </div>
                    `}});if(t)throw t;return{success:!0,data:o}}catch(o){return console.error("Error in sendOrderNotification:",o),{success:!1,error:o}}},sendCustomerOrderEmail:async(e,a,o)=>{try{const{data:t,error:i}=await n.functions.invoke("send-email",{body:{to:e,subject:`☕ Tu Pedido está en camino - Pedido #${o.orderId.slice(0,8)}`,html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                        ...
                        <body>
                            <div class="container">
                                <div class="content">
                                    <img src="${d}" width="80" style="margin-bottom: 20px;">
                                    <h1>¡Gracias por tu compra!</h1>
                                    <p>Hola ${a}, tu selección de café de especialidad está siendo preparada.</p>
                                    ...
                                    <div class="order-card">
                                        ...
                                        <div class="total">
                                            ...
                                            <span style="float: right;">USD ${o.total.toFixed(2)}</span>
                                        </div>
                                    </div>

                                    <p style="font-size: 13px; color: rgba(255,255,255,0.5);">Recibirás una notificación cuando tu pedido sea despachado.</p>
                                    <a href="${s}/#/track/${o.orderId}" style="display: inline-block; background: #C8AA6E; color: #000; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: bold; margin-top: 24px; font-size: 12px; text-transform: uppercase;">Rastrear mi pedido</a>
                                    ...
                                    <div style="margin-top: 32px; text-align: center; border-top: 1px solid rgba(200, 170, 110, 0.2); padding-top: 20px;">
                                        ...
                                        <a href="https://wa.me/${p.whatsapp.number.replace("+","")}?text=${encodeURIComponent("Hola, adjunto comprobante del pedido")}"
                    ...
                    `}});return{success:!i,data:t}}catch(t){return{success:!1,error:t}}},sendNewsletterWelcome:async e=>{try{const{data:a,error:o}=await n.functions.invoke("send-email",{body:{to:e,subject:"🌿 Tu puesto en la Sierra está reservado - Origen Sierra Nevada",html:`
                        <!DOCTYPE html>
                        <html>
                        <head>
                            <meta charset="utf-8">
                        ...
                        <body>
                            <div class="container">
                                <div class="header">
                                    <img src="${d}" width="140" alt="Origen Logo" style="filter: drop-shadow(0 0 15px rgba(200, 170, 110, 0.3));">
                                </div>
                                <div class="content">
                    ...
                    `}});return{success:!o,data:a}}catch(a){return console.error("Error sending newsletter email:",a),{success:!1,error:a}}},sendStatusUpdateEmail:async(e,a,o,t,i)=>{const r={pending_payment:{label:"Esperando Pago",emoji:"⏳",color:"#FF7043"},pending:{label:"Por Confirmar",emoji:"🧐",color:"#FFB74D"},paid:{label:"Pago Confirmado",emoji:"✅",color:"#66BB6A"},processing:{label:"Preparando tu Café",emoji:"☕",color:"#C8AA6E"},shipped:{label:"Pedido Enviado",emoji:"🚚",color:"#42A5F5"},delivered:{label:"Entregado",emoji:"🏠",color:"#AB47BC"},cancelled:{label:"Pedido Cancelado",emoji:"❌",color:"#EF5350"}}[t]||{label:t,emoji:"🔔",color:"#C8AA6E"};try{const{data:l,error:m}=await n.functions.invoke("send-email",{body:{to:e,subject:`${r.emoji} Actualización: Pedido #${o.slice(0,8)} - ${r.label}`,html:`
                        <div style="background-color: #050806; padding: 40px; font-family: sans-serif; color: white; text-align: center; border: 1px solid #C8AA6E; border-radius: 20px;">
                            <img src="${d}" width="70" style="margin-bottom: 24px;">
                            <h2 style="color: #C8AA6E;">Hola ${a},</h2>
                            <p style="color: rgba(255,255,255,0.7);">Tu pedido tiene una nueva actualización en su proceso de entrega:</p>
                            
                            <div style="background: rgba(255,255,255,0.05); padding: 30px; border-radius: 16px; margin: 30px 0; border: 1px solid ${r.color}44;">
                                <span style="font-size: 40px; display: block; margin-bottom: 10px;">${r.emoji}</span>
                                <span style="font-size: 10px; text-transform: uppercase; letter-spacing: 0.2em; color: ${r.color}; font-weight: bold;">Nuevo Estado</span>
                                <h1 style="color: ${r.color}; margin-top: 10px; font-size: 24px;">${r.label}</h1>
                            </div>
                            ...
                            ${t==="shipped"&&i?`
                                <div style="background: rgba(66, 165, 245, 0.1); border: 1px dashed #42A5F5; border-radius: 12px; padding: 20px; text-align: left; margin-bottom: 30px;">
                                    ...
                                    <p style="color: white; font-size: 14px; margin-bottom: 15px;">${i.note||"Tu pedido ya está en manos de la transportadora."}</p>
                                    ${i.receiptUrl?`
                                        <div style="text-align: center;">
                                            ...
                                            <img src="${i.receiptUrl}" style="max-width: 100%; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);">
                                        </div>
                                    `:""}
                                </div>
                            `:""}
                            ...
                            <div style="margin-top: 40px;">
                                <a href="${s}/#/track/${o}" style="background: #C8AA6E; color: black; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 11px; text-transform: uppercase; letter-spacing: 1px;">Ver Detalles del Pedido</a>
                            </div>
                            ...
                            <div style="margin-top: 32px; text-align: center; border-top: 1px solid rgba(200, 170, 110, 0.2); padding-top: 20px;">
                                ...
                                <a href="https://wa.me/${p.whatsapp.number.replace("+","")}?text=${encodeURIComponent("Hola, tengo una pregunta sobre mi pedido")} "
                                   style="background: #25D366; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block; font-size: 10px; text-transform: uppercase; letter-spacing: 0.08em;">
                                    💬 Contáctanos por WhatsApp
                                </a>
                            </div>
                    ...
                    `}});return{success:!m,data:l}}catch(l){return{success:!1,error:l}}}},v=Object.freeze(Object.defineProperty({__proto__:null,emailService:x},Symbol.toStringTag,{value:"Module"}));export{p as C,h as a,c as b,v as c,x as e,y as g};
