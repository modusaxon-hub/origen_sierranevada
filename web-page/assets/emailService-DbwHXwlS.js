                        ...
                        <body>
                            <div class="container">
                                <div class="content">
                                    ...
                                    <a href="${s}/#/account" style="display: inline-block; background: #C8AA6E; color: #000; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: bold; margin-top: 24px; font-size: 12px; text-transform: uppercase;">Rastrear mi pedido</a>
