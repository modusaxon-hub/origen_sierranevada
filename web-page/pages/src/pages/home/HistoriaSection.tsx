...
// ── Valores por defecto (fallback si Supabase no tiene datos) ──
const DEFAULT: HistoriaData = {
    title1: 'Nace en',
    title2: 'las nubes',
    paragraph1: 'En las faldas de la Sierra Nevada de Santa Marta, donde la niebla del Caribe besa las cumbres nevadas, nace un café único en el mundo. A más de 1.800 metros sobre el nivel del mar, el frío nocturno y la brisa del trópico crean un equilibrio irrepetible.',
    paragraph2: 'Cada grano que llega a tu taza es producto de décadas de conocimiento transmitido de generación en generación. Las familias que cuidan estos cafetales no producen volumen: producen expresión.',
    badgeTitle: 'Altitud promedio',
    badgeValue: '2.100',
    badgeUnit: 'msnm',
    badgeDesc: 'Sierra Nevada · Magdalena',
