                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div>
                        ...
                        <p className="text-gray-400 max-w-2xl font-light">
                            Gestión integral de inventario, miembros e identidad de marca.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {(metrics.ordersByStatus.pending > 0 || metrics.ordersByStatus.pending_payment > 0) && (
                            <div onClick={() => navigate('/admin/orders')} className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-xl flex items-center gap-4 cursor-pointer hover:bg-orange-500/20 transition-all border-l-4 border-l-orange-500">
                                <div className="w-10 h-10 rounded-full bg-orange-500 flex items-center justify-center text-black shadow-[0_0_15px_rgba(249,115,22,0.5)]">
                                    <span className="material-icons-outlined">shopping_cart</span>
                                </div>
                                <div>
                                    <p className="text-orange-400 text-[10px] font-bold uppercase tracking-widest">Pedidos por Gestionar</p>
                                    <p className="text-white text-sm font-medium">
                                        Hay {metrics.ordersByStatus.pending + metrics.ordersByStatus.pending_payment} pedidos pendientes
                                    </p>
                                </div>
                            </div>
                        )}
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="bg-white/5 border border-[#C5A065]/20 rounded-2xl p-6 hover:border-[#C5A065]/40 transition-all">
                            ...
                            {metrics.metricsLoading ? <div className="h-8 bg-white/5 rounded animate-pulse mb-2"></div> : <p className="text-3xl font-serif text-red-400 mb-2">{metrics.stockCritico}</p>}
                            <p className="text-xs text-white/40 font-light">Stock Crítico</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 border border-[#C5A065]/20 rounded-2xl p-6">
                        ...
                        <div className="space-y-4">
                            {(['pending_payment', 'pending', 'paid', 'shipped', 'delivered'] as const).map(status => {
                                ...
                                const allCounts = Object.values(metrics.ordersByStatus) as number[];
