    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
            ...
            <div className="flex items-center gap-4">
                {/* Back to Top - Redondo con flecha (Punto 6) */}
                <button
                    onClick={scrollToTop}
                    className={`pointer-events-auto w-12 h-12 rounded-full bg-surface-dark/40 backdrop-blur-md border border-[#C8AA6E]/30 text-[#C8AA6E] flex items-center justify-center transition-all duration-500 transform ${showScrollTop ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-0'}`}
                    title="Volver arriba"
                >
