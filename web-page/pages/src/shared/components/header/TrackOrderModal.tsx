            ...
            message={
                <div className="space-y-6 text-left mt-4">
                    ...
                    <form onSubmit={handleSearch} className="relative group">
                        <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none text-[#C5A065]/60 group-focus-within:text-[#C5A065] transition-colors">
                            <Search size={18} />
                        </div>
                        <input
                            type="text"
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-4 py-4 text-white placeholder:text-white/20 focus:border-[#C5A065]/50 focus:outline-none focus:ring-1 focus:ring-[#C5A065]/50 transition-all font-mono text-sm"
                            autoFocus
                        />
                    </form>
                    ...
                    <div className="flex flex-col gap-3">
                        <button
                            ...
                            className={`w-full py-4 rounded-xl font-bold uppercase text-[10px] tracking-[0.2em] transition-all flex items-center justify-center gap-2 ${!orderId.trim() || loading
                                    ...
                                    : 'bg-[#C5A065] text-black hover:bg-white shadow-xl shadow-[#C5A065]/10'
                                }`}
                        >
                            {loading ? (
