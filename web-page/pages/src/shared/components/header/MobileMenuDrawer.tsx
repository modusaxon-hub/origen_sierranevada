                    ...
                    <>
                        ...
                        {(isAdmin || user?.user_metadata?.role_name === 'Administrador') && (
                            <Link
                                to="/admin"
                                onClick={onClose}
                                className="flex items-center gap-4 p-4 rounded-2xl bg-[#C8AA6E]/10 border border-[#C8AA6E]/30 text-[#C8AA6E]"
                            >
                                <span className="material-icons-outlined">admin_panel_settings</span>
                                <div className="flex-1">
                                    <p className="text-sm font-bold uppercase tracking-widest">Panel Admin</p>
                                    <p className="text-[10px] opacity-70">Gestión de la plataforma</p>
                                </div>
                            </Link>
                        )}
