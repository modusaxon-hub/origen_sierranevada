                    ...
                    <div className="mb-16 bg-white/[0.02] border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-md">
                        <div className="flex flex-wrap gap-8">
                            ...
                            <div className="flex-1 min-w-[200px] space-y-3">
                                <label className="text-[10px] text-[#C5A065] font-bold uppercase tracking-widest">{lang === 'es' ? 'Proveedor' : 'Provider'}</label>
                                <select
                                    className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#C5A065] transition-colors"
                            ...
                            {/* Filtro por Marca */}
                            <div className="flex-1 min-w-[200px] space-y-3">
                                <label className="text-[10px] text-[#C5A065] font-bold uppercase tracking-widest">{lang === 'es' ? 'Marca' : 'Brand'}</label>
                                <select
                                    className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#C5A065] transition-colors"
                            ...
                            {/* Filtro por Peso */}
                            <div className="flex-1 min-w-[200px] space-y-3">
                                <label className="text-[10px] text-[#C5A065] font-bold uppercase tracking-widest">{lang === 'es' ? 'Peso' : 'Weight'}</label>
                                <select
                                    className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#C5A065] transition-colors"
                            ...
                            <div className="flex-1 min-w-[200px] space-y-3">
                                <label className="text-[10px] text-[#C5A065] font-bold uppercase tracking-widest">{lang === 'es' ? 'Tipo de Grano' : 'Grain Type'}</label>
                                <select
                                    className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#C5A065] transition-colors"
